...
struct ContentView: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            // Quick Actions
            HStack {                
                Button("Show \(getTranscriptionPreview()) (\(appState.hotkeyManagerService.currentCopyHotkeyString == SimpleHotkeyManager.NO_HOTKEY_SET ? "No shortcut" : appState.hotkeyManagerService.currentCopyHotkeyString))") {
